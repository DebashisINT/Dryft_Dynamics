package com.dryftdynamics.features.dashboard.presentation
...
import com.dryftdynamics.CustomStatic
import com.dryftdynamics.MySingleton
import com.dryftdynamics.R
import com.dryftdynamics.WorkerService
import com.dryftdynamics.app.*
import com.dryftdynamics.app.NewFileUtils.browseDocuments
import com.dryftdynamics.app.NewFileUtils.getExtension
import com.dryftdynamics.app.domain.*
import com.dryftdynamics.app.types.DashboardType
import com.dryftdynamics.app.types.FragType
import com.dryftdynamics.app.types.TopBarConfig
import com.dryftdynamics.app.uiaction.DisplayAlert
import com.dryftdynamics.app.utils.*
import com.dryftdynamics.app.utils.AppUtils.Companion.isProfile
...
import com.dryftdynamics.features.NewQuotation.AddQuotFormFragment
import com.dryftdynamics.features.NewQuotation.ViewAllQuotListFragment
import com.dryftdynamics.features.NewQuotation.ViewDetailsQuotFragment
import com.dryftdynamics.features.SearchLocation.SearchLocationFragment
import com.dryftdynamics.features.SearchLocation.locationInfoModel
import com.dryftdynamics.features.TA.ViewAllTAListFragment
import com.dryftdynamics.features.achievement.AchievementFragment
import com.dryftdynamics.features.activities.presentation.*
import com.dryftdynamics.features.addAttendence.*
import com.dryftdynamics.features.addAttendence.model.Leave_list_Response
import com.dryftdynamics.features.addorder.presentation.AddOrderFragment
...
import com.dryftdynamics.features.addshop.presentation.AddShopFragment
import com.dryftdynamics.features.addshop.presentation.OTPVerificationDialog
import com.dryftdynamics.features.addshop.presentation.ScanImageFragment
import com.dryftdynamics.features.addshop.presentation.ShowCardDetailsDialog
import com.dryftdynamics.features.alarm.model.AlarmData
import com.dryftdynamics.features.alarm.presetation.AttendanceReportFragment
import com.dryftdynamics.features.alarm.presetation.PerformanceReportFragment
import com.dryftdynamics.features.alarm.presetation.VisitReportDetailsFragment
import com.dryftdynamics.features.alarm.presetation.VisitReportFragment
import com.dryftdynamics.features.attendance.AttendanceFragment
import com.dryftdynamics.features.attendance.api.AttendanceRepositoryProvider
...
import com.dryftdynamics.features.averageshop.presentation.AverageShopFragment
import com.dryftdynamics.features.avgorder.presentation.AverageOrderFragment
import com.dryftdynamics.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.dryftdynamics.features.billing.presentation.AddBillingFragment
import com.dryftdynamics.features.billing.presentation.BillingDetailsFragment
import com.dryftdynamics.features.billing.presentation.BillingListFragment
import com.dryftdynamics.features.changepassword.presentation.ChangePasswordDialog
import com.dryftdynamics.features.chat.model.ChatListDataModel
import com.dryftdynamics.features.chat.model.ChatUserDataModel
import com.dryftdynamics.features.chat.model.GroupUserDataModel
import com.dryftdynamics.features.chat.presentation.*
import com.dryftdynamics.features.chatbot.presentation.ChatBotFragment
import com.dryftdynamics.features.chatbot.presentation.ChatBotShopListFragment
import com.dryftdynamics.features.chatbot.presentation.ReportsFragment
import com.dryftdynamics.features.chatbot.presentation.SelectLanguageDialog
import com.dryftdynamics.features.commondialog.presentation.CommonDialog
import com.dryftdynamics.features.commondialog.presentation.CommonDialogClickListener
import com.dryftdynamics.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.dryftdynamics.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.dryftdynamics.features.commondialogsinglebtn.OnDialogClickListener
import com.dryftdynamics.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.dryftdynamics.features.dailyPlan.prsentation.AllShopListFragment
import com.dryftdynamics.features.dailyPlan.prsentation.DailyPlanListFragment
import com.dryftdynamics.features.dailyPlan.prsentation.PlanDetailsFragment
import com.dryftdynamics.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.dryftdynamics.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.dryftdynamics.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.dryftdynamics.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.dryftdynamics.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.dryftdynamics.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.dryftdynamics.features.dashboard.presentation.model.ContentListResponseModel
import com.dryftdynamics.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.dryftdynamics.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.dryftdynamics.features.device_info.presentation.DeviceInfoListFragment
import com.dryftdynamics.features.document.DocumentRepoFeatureNewFragment
import com.dryftdynamics.features.document.presentation.DocumentListFragment
import com.dryftdynamics.features.document.presentation.DocumentTypeListFragment
import com.dryftdynamics.features.document.presentation.OpenFileWebViewFragment
import com.dryftdynamics.features.dymanicSection.presentation.AddDynamicFragment
import com.dryftdynamics.features.dymanicSection.presentation.AllDynamicListFragment
import com.dryftdynamics.features.dymanicSection.presentation.DynamicListFragment
import com.dryftdynamics.features.dymanicSection.presentation.EditDynamicFragment
import com.dryftdynamics.features.gpsDisabilityScreen.GpsDisableFragment
import com.dryftdynamics.features.home.presentation.HomeFragment
import com.dryftdynamics.features.homelocation.presentation.HomeLocationFragment
import com.dryftdynamics.features.homelocation.presentation.HomeLocationMapFragment
import com.dryftdynamics.features.know_your_state.KnowYourStateFragment
import com.dryftdynamics.features.lead.LeadFrag
import com.dryftdynamics.features.lead.ViewLeadFrag
import com.dryftdynamics.features.leaveapplynew.LeaveHome
import com.dryftdynamics.features.localshops.LocalShopListFragment
import com.dryftdynamics.features.localshops.LocalShopListMapFragment
import com.dryftdynamics.features.localshops.NearByShopsMapFragment
import com.dryftdynamics.features.location.*
import com.dryftdynamics.features.login.ShopFeedbackEntity
import com.dryftdynamics.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.dryftdynamics.features.login.presentation.LoginActivity
import com.dryftdynamics.features.logout.presentation.api.LogoutRepositoryProvider
import com.dryftdynamics.features.logoutsync.presentation.LogoutSyncFragment
import com.dryftdynamics.features.marketing.presentation.MarketingPagerFragment
import com.dryftdynamics.features.meetinglist.prsentation.MeetingListFragment
import com.dryftdynamics.features.member.model.TeamLocDataModel
import com.dryftdynamics.features.member.model.TeamShopListDataModel
import com.dryftdynamics.features.member.presentation.*
import com.dryftdynamics.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.dryftdynamics.features.micro_learning.presentation.MicroLearningListFragment
import com.dryftdynamics.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.dryftdynamics.features.myallowancerequest.MyallowanceRequestFragment
import com.dryftdynamics.features.myjobs.model.CustomerDataModel
import com.dryftdynamics.features.myjobs.presentation.*
import com.dryftdynamics.features.myorder.presentation.MyOrderListFragment
import com.dryftdynamics.features.myprofile.presentation.MyProfileFragment
import com.dryftdynamics.features.nearbyshops.presentation.BeatListFragment
import com.dryftdynamics.features.nearbyshops.presentation.NearByShopsListFragment
import com.dryftdynamics.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.dryftdynamics.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.dryftdynamics.features.newcollection.CollectionDetailsStatusFragment
import com.dryftdynamics.features.newcollection.CollectionShopListFragment
import com.dryftdynamics.features.newcollection.NewCollectionListFragment
import com.dryftdynamics.features.notification.NotificationFragment
import com.dryftdynamics.features.orderList.NewDateWiseOrderListFragment
import com.dryftdynamics.features.orderList.NewOrderListFragment
import com.dryftdynamics.features.orderList.OrderListFragment
import com.dryftdynamics.features.orderdetail.presentation.OrderDetailFragment
import com.dryftdynamics.features.orderhistory.ActivityMapFragment
import com.dryftdynamics.features.orderhistory.OrderhistoryFragment
import com.dryftdynamics.features.orderhistory.TimeLineFragment
import com.dryftdynamics.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.dryftdynamics.features.orderhistory.model.FetchLocationRequest
import com.dryftdynamics.features.orderhistory.model.FetchLocationResponse
import com.dryftdynamics.features.orderhistory.model.LocationData
import com.dryftdynamics.features.performance.GpsStatusFragment
import com.dryftdynamics.features.performance.PerformanceFragment
import com.dryftdynamics.features.performance.api.UpdateGpsStatusRepoProvider
import com.dryftdynamics.features.performance.model.UpdateGpsInputParamsModel
import com.dryftdynamics.features.permissionList.ViewPermissionFragment
import com.dryftdynamics.features.photoReg.PhotoAttendanceFragment
import com.dryftdynamics.features.photoReg.ProtoRegistrationFragment
import com.dryftdynamics.features.photoReg.RegisTerFaceFragment
import com.dryftdynamics.features.photoReg.TeamAttendanceFragment
import com.dryftdynamics.features.quotation.presentation.*
import com.dryftdynamics.features.reimbursement.presentation.EditReimbursementFragment
import com.dryftdynamics.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.dryftdynamics.features.reimbursement.presentation.ReimbursementFragment
import com.dryftdynamics.features.reimbursement.presentation.ReimbursementListFragment
import com.dryftdynamics.features.report.presentation.*
import com.dryftdynamics.features.returnsOrder.*
import com.dryftdynamics.features.settings.presentation.SettingsFragment
import com.dryftdynamics.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.dryftdynamics.features.shopdetail.presentation.*
import com.dryftdynamics.features.shopdetail.presentation.api.EditShopRepoProvider
import com.dryftdynamics.features.stock.StockDetailsFragment
import com.dryftdynamics.features.stock.StockListFragment
import com.dryftdynamics.features.stockAddCurrentStock.AddShopStockFragment
import com.dryftdynamics.features.stockAddCurrentStock.UpdateShopStockFragment
import com.dryftdynamics.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.dryftdynamics.features.stockCompetetorStock.AddCompetetorStockFragment
import com.dryftdynamics.features.stockCompetetorStock.CompetetorStockFragment
import com.dryftdynamics.features.stockCompetetorStock.ViewComStockProductDetails
import com.dryftdynamics.features.task.presentation.AddTaskFragment
import com.dryftdynamics.features.task.presentation.CalenderTaskFragment
import com.dryftdynamics.features.task.presentation.EditTaskFragment
import com.dryftdynamics.features.task.presentation.TaskListFragment
import com.dryftdynamics.features.timesheet.presentation.AddTimeSheetFragment
import com.dryftdynamics.features.timesheet.presentation.EditTimeSheetFragment
import com.dryftdynamics.features.timesheet.presentation.TimeSheetListFragment
import com.dryftdynamics.features.viewAllOrder.CartFragment
import com.dryftdynamics.features.viewAllOrder.OrderTypeListFragment
import com.dryftdynamics.features.viewAllOrder.ViewAllOrderListFragment
import com.dryftdynamics.features.viewAllOrder.ViewCartFragment
import com.dryftdynamics.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.dryftdynamics.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.dryftdynamics.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.dryftdynamics.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.dryftdynamics.features.viewPPDDStock.ViewOutstandingFragment
import com.dryftdynamics.features.viewPPDDStock.ViewPPDDListFragment
import com.dryftdynamics.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.dryftdynamics.features.viewPPDDStock.ViewStockFragment
import com.dryftdynamics.features.weather.presentation.WeatherFragment
import com.dryftdynamics.mappackage.MapActivity
import com.dryftdynamics.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xdryftdynamicslogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
