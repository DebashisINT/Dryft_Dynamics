package com.dryftdynamics.features.logoutsync.presentation
...
import com.dryftdynamics.app.AppDatabase
...
import com.dryftdynamics.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.dryftdynamics.features.addshop.api.AddShopRepositoryProvider
import com.dryftdynamics.features.billing.api.AddBillingRepoProvider
import com.dryftdynamics.features.billing.model.AddBillingInputParamsModel
...
import com.dryftdynamics.features.dashboard.presentation.ReasonDialog
...
import com.dryftdynamics.features.document.model.AddEditDocumentInputParams
import com.dryftdynamics.features.document.model.DocumentAttachmentModel
...
import com.dryftdynamics.features.location.model.*
import com.dryftdynamics.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
...
import com.dryftdynamics.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.dryftdynamics.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.dryftdynamics.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.dryftdynamics.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.dryftdynamics.features.orderhistory.model.*
...
import com.dryftdynamics.features.quotation.model.AddQuotInputModel
import com.dryftdynamics.features.shopdetail.presentation.api.EditShopRepoProvider
import com.dryftdynamics.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.dryftdynamics.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.dryftdynamics.features.stock.api.StockRepositoryProvider
import com.dryftdynamics.features.stock.model.AddStockInputParamsModel
import com.dryftdynamics.features.stockAddCurrentStock.AddShopStockFragment
import com.dryftdynamics.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.dryftdynamics.features.timesheet.model.AddTimeSheetInputModel
import com.dryftdynamics.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.dryftdynamics.features.viewAllOrder.model.AddOrderInputParamsModel
import com.dryftdynamics.features.viewAllOrder.model.AddOrderInputProductList
import com.dryftdynamics.mappackage.SendBrod
import com.dryftdynamics.widgets.AppCustomTextView
import com.dryftdynamics.MonitorService
import com.dryftdynamics.features.addshop.model.*
import com.dryftdynamics.features.addshop.model.assigntopplist.AddShopUploadImg
import com.dryftdynamics.features.login.api.LoginRepositoryProvider
import com.dryftdynamics.features.login.model.GetConcurrentUserResponse
import com.dryftdynamics.features.returnsOrder.ReturnProductList
import com.dryftdynamics.features.returnsOrder.ReturnRequest
import com.dryftdynamics.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
  ...
  /*private fun callLogshareApi(){
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log.zip").path))).use { out ->
                ...
                val addReqData = AddLogReqData()
                addReqData.user_id = Pref.user_id
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdryftdynamicslogsample/log.zip").path);
                val file = File(fileUrl.path)
                if (!file.exists()) {
                    checkToCallActivity()
                }
